...
class TenagaAhliResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Tabs::make(__('tenaga_ahli.tenaga_ahli'))
                    ->tabs([
                        Forms\Components\Tabs\Tab::make(__('tenaga_ahli.identitas'))
                            ...
                            ->columns(),
                        Forms\Components\Tabs\Tab::make(__('tenaga_ahli.kontak'))
                            ...
                            ->columns(),
                        Forms\Components\Tabs\Tab::make(__('tenaga_ahli.alamat'))
                            ->icon('heroicon-o-map')
                            ->schema([
                        ...
                        Forms\Components\Tabs\Tab::make(__('tenaga_ahli.status'))
                            ->icon('heroicon-o-identification')
                            ->schema([
                            ...
                            ->columns(),
                        Forms\Components\Tabs\Tab::make(__('tenaga_ahli.pendidikan'))
                            ->icon('heroicon-o-academic-cap')
                            ->schema([
                                TableRepeater::make('pendidikan')
                                    ->schema([
                        ...
                        Forms\Components\Tabs\Tab::make(__('tenaga_ahli.sertifikasi_keahlian'))
                        ...
                        Forms\Components\Tabs\Tab::make(__('riwayat_pengalaman_kerja.riwayat_pengalaman_kerja'))
